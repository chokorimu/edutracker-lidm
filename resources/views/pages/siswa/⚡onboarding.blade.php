...
<div class="flex h-screen bg-bone-light text-appleDark font-sans overflow-hidden selection:bg-appleDark selection:text-white">
    <aside class="w-64 bg-white/60 backdrop-blur-xl border-r border-bone-dark/60 flex flex-col justify-between z-20 flex-shrink-0">
        <div class="p-6 space-y-8">
            ...
            <nav class="space-y-1">
                <a href="{{ route('siswa.dashboard') }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                    Dashboard
                </a>
                <a href="{{ route('siswa.dashboard', ['tab' => 'calendar']) }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
                ...
                <a href="{{ route('siswa.dashboard', ['tab' => 'monitoring']) }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
                ...
                <a href="{{ route('siswa.dashboard', ['tab' => 'analytics']) }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
                ...
                <a href="{{ route('siswa.dashboard', ['tab' => 'notifications']) }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
                    Notifikasi
                </a>
                <a href="{{ route('siswa.dashboard', ['tab' => 'profile']) }}" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-[12px] text-sm font-medium transition-all text-appleMuted hover:bg-bone-dark/50 hover:text-appleDark">
        ...
        <div class="flex-1 overflow-y-auto no-scrollbar p-8 space-y-6 pb-24">
            @if($currentTab === 'dashboard')
                ...
                @if($status === "berat" || $status === "overload")
                    <div class="bg-[#FFF4E5] border border-[#FFE0B2] rounded-[24px] p-5 flex flex-col sm:flex-col justify-between gap-4 shadow-sm">
                        <div class="flex items-center gap-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div class="bg-white border border-bone-dark rounded-[24px] p-5 shadow-sm">
                        ...
                        <h2 class="text-3xl font-bold text-appleDark mt-2">{{ $data['profile']['sks_semester'] }} SKS</h2>
                    </div>
                    <div class="bg-white border border-bone-dark rounded-[24px] p-5 shadow-sm">
                        ...
                        <div class="h-32 flex items-end gap-4 mt-4 border-b border-l border-bone-dark p-2">
                            @foreach($data['ipk_history'] as $ipkEntry)
                                @php
                                    ...
                                    $scaledHeight = max($scaledHeight, 10);
                                @endphp
                    ...
                    @foreach($data['notifikasi'] as $notif)
                        <div class="p-5 flex items-start justify-between gap-4 hover:bg-bone-light/40 transition-colors">
                            <div class="flex items-start gap-4">
                                <span class="w-2.5 h-2.5 rounded-full mt-1.5 shrink-0 {{ $notif['tipe'] === 'peringatan' ? 'bg-appleRed' : ($notif['tipe'] === 'pengingat' ? 'bg-appleOrange' : ($notif['tipe'] === 'sukses' ? 'bg-appleGreen' : 'bg-blue-500')) }}"></span>
                                <div>
